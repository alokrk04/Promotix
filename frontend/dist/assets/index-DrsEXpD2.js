...
async function request(path, options = {}) {
  ...
  try {
    ...
    if (res.status === 401) {
      ...
      let detail;
      try {
        detail = JSON.parse(text2);
      } catch {
      }
      throw new Error((detail == null ? void 0 : detail.detail) || (detail == null ? void 0 : detail.error) || "Session expired");
    }
    if (!res.ok) {
      const text2 = await res.text();
      let detail;
      ...
      throw new Error((detail == null ? void 0 : detail.detail) || (detail == null ? void 0 : detail.error) || "Request failed");
    }
...
function AuthProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    const token = localStorage.getItem("token");
    if (token) {
      api.verifyToken().then((d) => setAdmin(d)).catch(() => {
        localStorage.removeItem("token");
        setAdmin(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthContext.Provider, { value: { admin, loading, login, logout }, children });
}
...
function Hero({ content, stats }) {
  var _a, _b, _c, _d, _e, _f, _g, _h;
  const c = content || {};
  const s = stats || {};
  const statsArr = [
    { value: ((_a = s.brands) == null ? void 0 : _a.value) || "150+", label: ((_b = s.brands) == null ? void 0 : _b.label) || "Brands & Properties" },
    { value: ((_c = s.followers) == null ? void 0 : _c.value) || "12.1K", label: ((_d = s.followers) == null ? void 0 : _d.label) || "Instagram Followers" },
    { value: ((_e = s.years) == null ? void 0 : _e.value) || "3+", label: ((_f = s.years) == null ? void 0 : _f.label) || "Years of Excellence" },
    { value: ((_g = s.satisfaction) == null ? void 0 : _g.value) || "98%", label: ((_h = s.satisfaction) == null ? void 0 : _h.label) || "Client Satisfaction" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "hero", className: "min-h-screen flex items-center py-24 sm:py-28 lg:py-32 px-4 sm:px-6 lg:px-8 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-[700px] h-[700px] rounded-full bg-gradient-to-br from-violet/5 to-transparent top-[-250px] right-[-150px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-[450px] h-[450px] rounded-full bg-gradient-to-br from-cyan/5 to-transparent bottom-[-100px] left-[-80px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-6xl mx-auto text-center relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-[clamp(2.4rem,6vw,5.2rem)] sm:text-[clamp(2.8rem,6.5vw,5.5rem)] font-extrabold leading-[1.04] tracking-tight mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gt", children: c.line1 || "We Turn Ideas Into Impact." }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 120, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-slate leading-relaxed max-w-[580px] mx-auto mb-8 sm:mb-10 px-2 sm:px-0", children: c.subtitle || "From cinematic marketing to premium property solutions." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#pricing", className: "btn-p w-full sm:w-auto", children: "Start Your Package →" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://forms.gle/pKp5jPdLpNHV17Ps5", target: "_blank", className: "btn-p w-full sm:w-auto", style: { background: "linear-gradient(135deg,#7C3AED,#4F46E5)" }, children: "Connect With Promotix" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 360, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 lg:gap-10 mt-12 sm:mt-14 pt-8 sm:pt-10 border-t border-black/5", children: statsArr.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl sm:text-3xl font-extrabold gt", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] sm:text-xs text-slate mt-1 leading-relaxed", children: stat.label })
      ] }, i)) }) })
    ] })
  ] });
}
...
function Services({ content, connectServices, propertiesServices }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-violet/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "sh mt-4", children: ((_c = c.connect) == null ? void 0 : _c.heading) || "Promotix — Marketing Agency" }),
...
function About({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-cyan/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl grid gap-10 lg:grid-cols-2 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { from: "left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag", children: "About Promotix" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "sh mt-4", dangerouslySetInnerHTML: { __html: purify.sanitize(tagline) } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ss mb-4 lg:text-left", dangerouslySetInnerHTML: { __html: purify.sanitize(paragraph1) } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ss lg:text-left", children: c.paragraph2 || "" })
    ] }) }),
...
function Portfolio() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "portfolio", className: "py-20 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "sh mt-4", children: [
        "Brands We ",
...
function Process({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "process", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-violet/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag", children: "How We Work" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "sh mt-4", children: [
        "Our ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gt", children: "6-Step Process" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ss mx-auto", children: c.subtitle || "A proven framework." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-[820px] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-10 top-3 bottom-3 w-px bg-gradient-to-b from-transparent via-violet/50 to-transparent hidden md:block" }),
      items.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { from: "left", delay: i * 80, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 sm:gap-8 items-start pb-8 sm:pb-11 last:pb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-16 h-16 sm:w-20 sm:h-20 min-w-[64px] sm:min-w-[80px] rounded-full flex items-center justify-center text-base sm:text-lg font-extrabold border-2 relative z-10 bg-gradient-to-br ${stepColors[i % stepColors.length]}`, children: step.num || String(i + 1).padStart(2, "0") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-0 sm:pt-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg sm:text-xl font-bold mb-2", children: step.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate leading-relaxed text-sm", children: step.desc })
        ] })
      ] }) }, i))
    ] })
  ] }) });
}
function PricingCard({ plan, featured, badge, delay }) {
  const p = plan || {};
  const scrollToContact = () => {
    var _a;
    (_a = document.getElementById("contact")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay, from: featured ? "zoom" : "up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `gcard p-6 flex flex-col ${badge ? "relative" : ""} ${featured ? "bg-violet/10 border-violet/40 shadow-[0_25px_60px_rgba(124,58,237,0.12)]" : ""}`, children: [
    badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-[-14px] left-1/2 -translate-x-1/2 px-5 py-1.5 rounded-full bg-gradient-to-r from-violet to-indigo-600 text-xs font-bold tracking-wider text-white whitespace-nowrap", children: badge }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-sm font-semibold mb-2 ${featured ? "text-violet-light" : "text-slate"}`, children: p.name || "Plan" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `text-3xl font-extrabold mb-1 ${featured ? "gt" : ""}`, children: [
      p.price || "₹0",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-normal text-slate bg-none", style: featured ? { WebkitTextFillColor: "#64748B", color: "#64748B" } : {}, children: "/mo" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate text-xs mb-5", children: p.period || "" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "border-t border-black/5 pt-4 mb-5 flex-1 space-y-2", children: (p.features || []).map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-slate text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green text-xs", children: "✓" }),
      " ",
      f
    ] }, i)) }),
...
function Pricing({ content }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "pricing", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-cyan/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag", children: "Pricing Plans" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "sh mt-4", children: [
        "Transparent, ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gt", children: "Premium Pricing" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ss mx-auto", children: "Invest in your brand's future. All plans include dedicated support." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mx-auto", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PricingCard, { plan, featured: plan._featured, badge: plan.badge, delay: i * 100 }, i)) })
  ] }) });
}
function FAQ({ items }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-violet/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag", children: "FAQ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "sh mt-4", children: [
        "Frequently Asked ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gt", children: "Questions" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[760px] mx-auto space-y-4", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 70, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-black/10 rounded-xl overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => setOpenIdx(openIdx === i ? null : i),
          className: `w-full flex justify-between items-center gap-4 px-4 sm:px-6 py-4 text-sm font-semibold text-left transition-colors ${openIdx === i ? "bg-violet/10 text-violet-light" : "hover:bg-black/[0.025]"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: faq.q }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-6 h-6 rounded-full border border-black/20 flex items-center justify-center flex-shrink-0 text-sm transition-all ${openIdx === i ? "border-violet bg-violet/20 rotate-45" : ""}`, children: "+" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `overflow-hidden transition-all duration-300 ${openIdx === i ? "max-h-72" : "max-h-0"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 sm:px-6 pb-5 text-slate leading-relaxed text-sm", children: faq.a })
        }
      )
    ] }) }, i)) })
  ] }) });
...
function Contact({ content }) {
  ...
  const contactInfo = [
    ...
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    ] }), label: "Instagram", value: c.instagram || "@promotix.official" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-cyan/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "sh mt-4", children: [
        "Let's Build Something ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gt", children: "Extraordinary" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ss mx-auto", children: "We respond within 24 hours." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1fr_1.25fr] lg:gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { from: "left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-7", children: "Contact Information" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block text-left space-y-5 w-full max-w-[360px] mx-auto lg:mx-0", children: contactInfo.map((info, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-violet/10 border border-violet/20 flex items-center justify-center text-lg flex-shrink-0", children: info.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm", children: info.label }),
            info.label === "Instagram" ? /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/promotix.official?igsh=bWFiaTJ0N2drNGkz", target: "_blank", className: "text-slate text-sm no-underline hover:text-violet transition-colors", children: info.value }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate text-sm", children: info.value })
          ] })
        ] }, i)) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { from: "right", delay: 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "gcard p-5 sm:p-8 lg:p-9", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-5", children: "Send Us a Message" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `w-full py-4 rounded-xl text-white font-semibold transition-all shadow-lg ${status === "ok" ? "bg-gradient-to-r from-emerald-600 to-emerald-500" : status === "error" ? "bg-gradient-to-r from-red-600 to-red-500" : "bg-gradient-to-r from-violet to-indigo-600 shadow-violet/30 hover:-translate-y-0.5 hover:shadow-xl"}`,
            children: status === "sending" ? "Sending…" : status === "ok" ? "Message Sent! ✓" : status === "error" ? "Failed — Try Again" : "Send Message →"
          }
        )
      ] }) })
    ] })
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-14 px-4 sm:px-6 lg:px-8 border-t border-black/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-shell max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 xl:grid-cols-[1.4fr_1fr_1fr_1.1fr] mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center md:justify-start gap-3 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-extrabold tracking-widest", children: "PROMOTIX" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate text-sm leading-relaxed max-w-[270px] mx-auto md:mx-0", children: "Promotix is a specialized digital marketing agency. By providing focused social media management, commercial scriptwriting, and growth campaigns, the agency transforms presence into a measurable business designed to elevate brand and drive attract consumer." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold tracking-widest uppercase text-slate mb-5", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 list-none", children: ["Promotix Connect", "Promotix Properties", "Branding", "Social Media", "Performance Ads"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-slate text-sm no-underline hover:text-black transition-colors", children: l }) }, l)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold tracking-widest uppercase text-slate mb-5", children: "Company" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 list-none", children: ["About", "Portfolio", "Process", "Pricing", "Contact"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${l.toLowerCase()}`, className: "text-slate text-sm no-underline hover:text-black transition-colors", children: l }) }, l)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold tracking-widest uppercase text-slate mb-5", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 list-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "text-slate text-sm no-underline hover:text-black transition-colors", children: [
            "First Floor, Dumale Building,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Ashok Nagar, Nipani, Karnataka 591201"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919380712430", className: "text-slate text-sm no-underline hover:text-black transition-colors", children: "+91 93807 12430" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://instagram.com/promotix.official", className: "text-slate text-sm no-underline hover:text-black transition-colors", children: "@promotix.official" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-center md:justify-between items-center pt-6 border-t border-black/5 text-slate text-xs gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "© 2026 Promotix. All rights reserved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/admin", className: "text-slate no-underline hover:text-black transition-colors", children: "Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-slate no-underline hover:text-black transition-colors", children: "Privacy Policy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-slate no-underline hover:text-black transition-colors", children: "Terms of Service" })
      ] })
    ] })
  ] }) });
}
function Home() {
  ...
  reactExports.useEffect(() => {
    api.getWebsite().then(setData).catch(() => setError(true)).finally(() => setLoading(false));
  }, []);
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 flex flex-col items-center justify-center gap-8 bg-[#F8F9FA] z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-extrabold tracking-widest gt", children: "PROMOTIX" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-44 h-0.5 bg-black/10 rounded overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full bg-gradient-to-r from-violet to-cyan rounded animate-pulse" }) })
    ] });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 flex flex-col items-center justify-center gap-6 bg-[#F8F9FA] z-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl", children: "⚠️" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-bold text-center max-w-md", children: "Could not load website content. Make sure the backend server is running." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.location.reload(), className: "btn-p", children: "Retry" })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      (contact == null ? void 0 : contact.is_visible) && /* @__PURE__ */ jsxRuntimeExports.jsx(Contact, { content: contact.content })
    ] }),
...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-slate-100 flex items-center justify-center p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-12 w-full max-w-sm shadow-2xl text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-extrabold mb-1 gt", children: "Promotix Admin" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate text-sm mb-8", children: "Sign in to manage website content" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      ...
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mb-4", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "submit",
...
function SectionEditor({ sections, onUpdate }) {
  const [editStates, setEditStates] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    toast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `fixed top-4 right-4 z-50 px-5 py-3 rounded-xl text-white font-semibold text-sm transition-all ${toast.type === "ok" ? "bg-emerald-600" : "bg-red-600"}`, children: toast.msg }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold mb-4", children: "Website Sections" }),
    sections.map((section) => {
      const editState = editStates[section.id];
      const displayContent = (editState == null ? void 0 : editState.content) ?? section.content;
      const rawValue = (editState == null ? void 0 : editState.contentRaw) ?? JSON.stringify(displayContent, null, 2);
      const hasValidEdit = editState && "content" in editState;
      const hasError = errors[section.id];
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-slate-200 rounded-xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold capitalize", children: section.key }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-slate", children: section.title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => handleToggle(section),
              className: `px-3 py-1 text-xs font-semibold rounded-lg transition-colors ${section.is_visible ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
              children: section.is_visible ? "Visible" : "Hidden"
            }
          ) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            className: `w-full p-3 border rounded-lg text-sm font-mono h-32 resize-y outline-none transition-colors ${hasError ? "border-red-400 focus:border-red-500" : "border-slate-200 focus:border-violet"}`,
            value: rawValue,
            onChange: (e) => handleContentChange(section.id, e.target.value)
          }
        ),
        hasError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-xs mt-1", children: hasError }),
...
function ListManager({ title, items, fields, onCreate, onUpdate, onDelete }) {
  ...
  const handleCreate = async () => {
    var _a;
    if (!newItem[(_a = fields[0]) == null ? void 0 : _a.key]) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold mb-4", children: title }),
    items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-slate-200 rounded-xl p-4 flex gap-3 items-start", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-3 py-2 text-xs font-semibold rounded-lg ${item.is_visible ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`,
          children: item.is_visible ? "ON" : "OFF"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-end", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleCreate, className: "px-4 py-2 bg-violet/10 border border-dashed border-violet/30 text-violet text-sm font-semibold rounded-lg hover:bg-violet/20", children: "+ Add" })
    ] })
  ] });
}
function MessagesPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate text-sm", children: "No messages" }),
    filtered.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-4 flex-wrap", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center text-xs text-slate", children: [
              ...
              !m.is_read && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => api.markRead(m.id).then(load), className: "px-2 py-1 border border-slate-200 rounded-lg hover:bg-slate-50", children: "Mark Read" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => api.deleteMessage(m.id).then(load), className: "px-2 py-1 bg-red-100 text-red-600 rounded-lg hover:bg-red-200", children: "✕" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed", children: m.message })
        ]
      },
      m.id
    ))
...
function Admin() {
  ...
  const [tab, setTab] = reactExports.useState("sections");
  reactExports.useEffect(() => {
    if (!admin) return;
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-slate-100 flex items-center justify-center text-slate text-sm", children: "Checking authentication..." });
  if (!admin) return /* @__PURE__ */ jsxRuntimeExports.jsx(Login, {});
  const tabs = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-10 bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold", children: "✏️ Website Editor" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", target: "_blank", className: "px-3 py-1.5 border border-slate-200 rounded-lg text-sm font-semibold hover:bg-slate-50", children: "View Site" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          logout();
          navigate("/admin");
        }, className: "px-3 py-1.5 border border-slate-200 rounded-lg text-sm font-semibold hover:bg-slate-50", children: "Logout" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-slate-200 bg-white px-6 flex gap-1", children: tabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setTab(t.key),
        className: `px-4 py-2.5 text-sm font-semibold border-b-2 transition-colors ${tab === t.key ? "border-violet text-violet" : "border-transparent text-slate hover:text-frost"}`,
        children: t.label
      },
      t.key
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto p-6", children: [
      tab === "sections" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionEditor,
        {
          sections,
      ...
      tab === "services" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ListManager,
        {
          title: "Services",
          items: services,
      ...
      tab === "portfolio" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ListManager,
        {
          title: "Portfolio",
          items: portfolio,
      ...
      tab === "testimonials" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ListManager,
        {
          title: "Testimonials",
          items: testimonials,
